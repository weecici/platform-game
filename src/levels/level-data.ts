...
export const LEVEL_PARKOUR_CITY: LevelConfig = {
  ...
  platforms: [
    ...
    // Decorative mini house at spawn (non-essential for traversal)
    {
      position: [-3.7, 0.55, 3.8],
      size: [3.8, 0.3, 3.6],
      color: 0x6f7e8d,
      texture: 'stone',
      textureRepeat: [2, 2],
  ...
  decorations: [
    ...
    {
      type: 'model',
      modelPath: '/assets/models/rubber-duck/rubber_duck_toy_1k.gltf',
      position: [-4.8, 0.5, 1.7],
      scale: [0.95, 0.95, 0.95],
      animate: { rotateY: 0.3, bobSpeed: 1.3, bobHeight: 0.08 },
    },
    {
      type: 'model',
    ...
    },
    {
      type: 'model',
      modelPath: '/assets/models/rubber-duck/rubber_duck_toy_1k.gltf',
      position: [-3.7, 4.25, 3.8],
      scale: [0.55, 0.55, 0.55],
      animate: { rotateY: -0.55, bobSpeed: 1.0, bobHeight: 0.05 },
    },

    // Trees around spawn area
    {
      type: 'model',
      modelPath: '/assets/models/tree/scene.gltf',
    ...
    },
    {
      type: 'model',
      modelPath: '/assets/models/rubber-duck/rubber_duck_toy_1k.gltf',
      position: [15, 10.5, -102],
      scale: [0.85, 0.85, 0.85],
      animate: { rotateY: -0.5 },
    },

    // Giant roadside decorations
    {
      type: 'model',
      modelPath: '/assets/models/rubber-duck/rubber_duck_toy_1k.gltf',
      position: [-18, -4.75, -10],
    ...
    {
      type: 'model',
      modelPath: '/assets/models/clouds/scene.gltf',
      position: [-28, 38, 10],
    ...
    // --- Starting area ---
    { type: 'torusknot', position: [-1.5, 2, -2.7], scale: [0.35, 0.35, 0.35], color: 0xffdd00, emissive: 0xffaa00, animate: { rotateY: 2, bobSpeed: 2, bobHeight: 0.25 }, collectible: 'box' },
    { type: 'torusknot', position: [0, 2.1, -3.3], scale: [0.35, 0.35, 0.35], color: 0x44ddff, emissive: 0x22aadd, animate: { rotateY: 2, bobSpeed: 2.5, bobHeight: 0.25 }, collectible: 'cylinder' },
    { type: 'torusknot', position: [1.5, 2, -2.7], scale: [0.35, 0.35, 0.35], color: 0xff44ff, emissive: 0xdd22dd, animate: { rotateY: 1.5, bobSpeed: 2, bobHeight: 0.25 }, collectible: 'box' },
